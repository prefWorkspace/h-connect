    ...
    return function a(o, s, c) {
                    ...
                    switch (n.browser) {
                        ...
                        case "edge":
                            if (!s || !s.shimPeerConnection || !t.shimEdge)
                                return r("MS edge shim is not included in this adapter release."), i;
        ...
        3: [function(e, t, r) {
            ...
            Object.defineProperty(r, "shimGetDisplayMedia", {
                ...
                r.shimOnTrack = function(a) {
                    {
                        var e;
                        "object" !== (void 0 === a ? "undefined" : s(a)) || !a.RTCPeerConnection || "ontrack" in a.RTCPeerConnection.prototype ? c.wrapPeerConnectionEvent(a, "track", function(e) {
                            ...
                            enumerable: !0,
                            configurable: !0
                        }), e = a.RTCPeerConnection.prototype.setRemoteDescription, a.RTCPeerConnection.prototype.setRemoteDescription = function() {
                            var i = this;
                ...
                r.shimGetSendersWithDtmf = function(e) {
                    {
                        var n,
                            ...
                            t,
                            o;
                        "object" === (void 0 === e ? "undefined" : s(e)) && e.RTCPeerConnection && !("getSenders" in e.RTCPeerConnection.prototype) && "createDTMFSender" in e.RTCPeerConnection.prototype ? (n = function(e, t) {
                            return {
                                track: t,
                                get dtmf() {
                        ...
                        }, i = e.RTCPeerConnection.prototype.addTrack, e.RTCPeerConnection.prototype.addTrack = function(e, t) {
                            var r = i.apply(this, arguments);
                            return r || (r = n(this, e), this._senders.push(r)), r
                        }, r = e.RTCPeerConnection.prototype.removeTrack, e.RTCPeerConnection.prototype.removeTrack = function(e) {
                            r.apply(this, arguments);
                            var t = this._senders.indexOf(e);
                            -1 !== t && this._senders.splice(t, 1)
                        }), a = e.RTCPeerConnection.prototype.addStream, e.RTCPeerConnection.prototype.addStream = function(e) {
                            var t = this;
                        ...
                        }, t = e.RTCPeerConnection.prototype.removeStream, e.RTCPeerConnection.prototype.removeStream = function(e) {
                            var r = this;
                            this._senders = this._senders || [],
                                t.apply(this, [e]),
                        ...
                        }) : "object" === (void 0 === e ? "undefined" : s(e)) && e.RTCPeerConnection && "getSenders" in e.RTCPeerConnection.prototype && "createDTMFSender" in e.RTCPeerConnection.prototype && e.RTCRtpSender && !("dtmf" in e.RTCRtpSender.prototype) && (o = e.RTCPeerConnection.prototype.getSenders, e.RTCPeerConnection.prototype.getSenders = function() {
                            var t = this,
                                e = o.apply(this, []);
                ...
                r.shimGetStats = function(e) {
                    ...
                    e.RTCPeerConnection.prototype.getStats = function() {
                        ...
                        if (0 === s.length && (0 === arguments.length || "function" != typeof t))
                            return s.apply(this, []);
                        function a(e) {
                            var n = {};
                ...
                r.shimSenderReceiverGetStats = function(a) {
                    if (!("object" === (void 0 === a ? "undefined" : s(a)) && a.RTCPeerConnection && a.RTCRtpSender && a.RTCRtpReceiver))
                        return;
                    {
                        var r,
                            t;
                        "getStats" in a.RTCRtpSender.prototype || ((r = a.RTCPeerConnection.prototype.getSenders) && (a.RTCPeerConnection.prototype.getSenders = function() {
                            var t = this,
                                e = r.apply(this, []);
                            return e.forEach(function(e) {
                                return e._pc = t
                            }), e
                        }), (t = a.RTCPeerConnection.prototype.addTrack) && (a.RTCPeerConnection.prototype.addTrack = function() {
                    ...
                    {
                        var n;
                        "getStats" in a.RTCRtpReceiver.prototype || ((n = a.RTCPeerConnection.prototype.getReceivers) && (a.RTCPeerConnection.prototype.getReceivers = function() {
                            var t = this,
                                e = n.apply(this, []);
                            return e.forEach(function(e) {
                                return e._pc = t
                ...
                r.shimAddTrackRemoveTrack = function(o) {
                    ...
                    o.RTCPeerConnection.prototype.addStream = function(e) {
                        ...
                        this._reverseStreams[e.id] || (t = new o.MediaStream(e.getTracks()), this._streams[e.id] = t, this._reverseStreams[t.id] = e, e = t),
                            n.apply(this, [e])
                    };
                    ...
                    o.RTCPeerConnection.prototype.removeStream = function(e) {
                        ...
                        o.RTCPeerConnection.prototype.addTrack = function(t, e) {
                            ...
                            this._streams = this._streams || {},
                                this._reverseStreams = this._reverseStreams || {};
                            var i,
                                a = this._streams[e.id];
                            return a ? (a.addTrack(t), Promise.resolve().then(function() {
                                r.dispatchEvent(new Event("negotiationneeded"))
                            })) : (i = new o.MediaStream([t]), this._streams[e.id] = i, this._reverseStreams[i.id] = e, this.addStream(i)), this.getSenders().find(function(e) {
                                return e.track === t
                            })
                        },
                        ["createOffer", "createAnswer"].forEach(function(e) {
                            var t = o.RTCPeerConnection.prototype[e],
                                r = d({}, e, function() {
                                    var r = this,
                                        n = arguments;
                                    return arguments.length && "function" == typeof arguments[0] ? t.apply(this, [function(e) {
                                        var t = i(r, e);
                                        n[0].apply(null, [t])
                                    }, function(e) {
                                        n[1] && n[1].apply(null, e)
                                    }, arguments[2]]) : t.apply(this, arguments).then(function(e) {
                                        return i(r, e)
                                    })
                                });
                    ...
                    o.RTCPeerConnection.prototype.setLocalDescription = function(e) {
                        return arguments.length && e.type && (n = this, i = (t = e).sdp, Object.keys(n._reverseStreams || []).forEach(function(e) {
                            var t = n._reverseStreams[e],
                                r = n._streams[t.id];
        ...
        4: [function(e, t, r) {
            ...
            Object.defineProperty(r, "__esModule", {
                ...
                r.shimGetDisplayMedia = function(a, e) {
                    if (a.navigator.mediaDevices && "getDisplayMedia" in a.navigator.mediaDevices)
                        return;
        ...
        5: [function(e, t, r) {
            ...
            r.shimGetUserMedia = function(e) {
                ...
                if (!o.mediaDevices)
                    return;
                function s(i) {
                    if ("object" !== (void 0 === i ? "undefined" : d(i)) || i.mandatory || i.optional)
                        return i;
                    var a = {};
                    return Object.keys(i).forEach(function(t) {
                        var r,
                            n,
                            e;
                        "require" !== t && "advanced" !== t && "mediaSource" !== t && (void 0 !== (r = "object" === d(i[t]) ? i[t] : {
                            ideal: i[t]
                        }).exact && "number" == typeof r.exact && (r.min = r.max = r.exact), n = function(e, t) {
                            return e ? e + t.charAt(0).toUpperCase() + t.slice(1) : "deviceId" === t ? "sourceId" : t
                        }, void 0 !== r.ideal && (a.optional = a.optional || [], e = {}, "number" == typeof r.ideal ? (e[n("min", t)] = r.ideal, a.optional.push(e), (e = {})[n("max", t)] = r.ideal) : e[n("", t)] = r.ideal, a.optional.push(e)), void 0 !== r.exact && "number" != typeof r.exact ? (a.mandatory = a.mandatory || {}, a.mandatory[n("", t)] = r.exact) : ["min", "max"].forEach(function(e) {
                ...
                function n(r, n) {
                    if (61 <= c.version)
                        return n(r);
                    var e;
                    if ((r = JSON.parse(JSON.stringify(r))) && "object" === d(r.audio) && ((e = function(e, t, r) {
                        t in e && !(r in e) && (e[r] = e[t], delete e[t])
                    })((r = JSON.parse(JSON.stringify(r))).audio, "autoGainControl", "googAutoGainControl"), e(r.audio, "noiseSuppression", "googNoiseSuppression"), r.audio = s(r.audio)), r && "object" === d(r.video)) {
                        var i = (i = r.video.facingMode) && ("object" === (void 0 === i ? "undefined" : d(i)) ? i : {
                                ideal: i
                            }),
                            t = c.version < 66;
                        if (i && ("user" === i.exact || "environment" === i.exact || "user" === i.ideal || "environment" === i.ideal) && (!o.mediaDevices.getSupportedConstraints || !o.mediaDevices.getSupportedConstraints().facingMode || t)) {
                            ...
                            var a = void 0;
                            if ("environment" === i.exact || "environment" === i.ideal ? a = ["back", "rear"] : "user" !== i.exact && "user" !== i.ideal || (a = ["front"]), a)
                ...
                var c = a.detectBrowser(e);
                {
                    ...
                    o.mediaDevices.getUserMedia && (r = o.mediaDevices.getUserMedia.bind(o.mediaDevices), o.mediaDevices.getUserMedia = function(e) {
        ...
        6: [function(e, t, r) {
            ...
            r.shimRTCIceCandidate = function(t) {
                ...
                r.shimMaxMessageSize = function(e) {
                    ...
                    e.RTCPeerConnection.prototype.setRemoteDescription = function(e) {
                        var t,
                            ...
                            o,
                            s;
                        return this._sctp = null, "chrome" === c.browser && 76 <= c.version && "plan-b" === this.getConfiguration().sdpSemantics && Object.defineProperty(this, "sctp", {
                            get: function() {
                                return void 0 === this._sctp ? null : this._sctp
                            },
                            enumerable: !0,
                            ...
                            return r != r ? -1 : r
                        }(e), o = t, s = 65536, "firefox" === c.browser && (s = c.version < 57 ? -1 === o ? 16384 : 2147483637 : c.version < 60 ? 57 === c.version ? 65535 : 65536 : 2147483637), r = s, n = function(e, t) {
                            var r = 65536;
                            "firefox" === c.browser && 57 === c.version && (r = 65535);
                            var n = p.default.matchPrefix(e.sdp, "a=max-message-size:");
                            return 0 < n.length ? r = parseInt(n[0].substr(19), 10) : "firefox" === c.browser && -1 !== t && (r = 2147483637), r
                        }(e, t), i = void 0, i = 0 === r && 0 === n ? Number.POSITIVE_INFINITY : 0 === r || 0 === n ? Math.max(r, n) : Math.min(r, n), a = {}, Object.defineProperty(a, "maxMessageSize", {
                            get: function() {
                                return i
                            }
                        }), this._sctp = a), d.apply(this, arguments)
                    }
                },
                r.shimSendThrowTypeError = function(e) {
                    ...
                    function t(r, n) {
                        ...
                        r.send = function(e) {
                            ...
                            if ("open" === r.readyState && n.sctp && t > n.sctp.maxMessageSize)
                                throw new TypeError("ConnectMessage too large (can send a maximum of " + n.sctp.maxMessageSize + " bytes)");
                        ...
                        ["setLocalDescription", "setRemoteDescription"].forEach(function(e) {
                            ...
                            r[e] = function() {
                                return this._connectionstatechangepoly || (this._connectionstatechangepoly = function(e) {
                                    var t,
                                        r = e.target;
                                    return r._lastConnectionState !== r.connectionState && (r._lastConnectionState = r.connectionState, t = new Event("connectionstatechange", e), r.dispatchEvent(t)), e
                ...
                r.removeAllowExtmapMixed = function(e) {
                    ...
                    if ("chrome" === t.browser && 71 <= t.version)
                        return;
                ...
                r.shimPeerConnection = function(e) {
                    var t = o.detectBrowser(e);
                    {
                        ...
                        e.RTCIceGatherer && (e.RTCIceCandidate || (e.RTCIceCandidate = function(e) {
                            ...
                            return e
                        }), t.version < 15025 && (r = Object.getOwnPropertyDescriptor(e.MediaStreamTrack.prototype, "enabled"), Object.defineProperty(e.MediaStreamTrack.prototype, "enabled", {
                            set: function(e) {
                                r.set.call(this, e);
        ...
        11: [function(e, t, r) {
            ...
            Object.defineProperty(r, "shimGetDisplayMedia", {
                ...
                r.shimPeerConnection = function(n) {
                    ...
                    if ("object" !== (void 0 === n ? "undefined" : c(n)) || !n.RTCPeerConnection && !n.mozRTCPeerConnection)
                        return;
                    !n.RTCPeerConnection && n.mozRTCPeerConnection && (n.RTCPeerConnection = n.mozRTCPeerConnection);
                    i.version < 53 && ["setLocalDescription", "setRemoteDescription", "addIceCandidate"].forEach(function(e) {
                        var t = n.RTCPeerConnection.prototype[e],
                            r = function(e, t, r) {
                    ...
                    {
                        var r;
                        i.version < 68 && (r = n.RTCPeerConnection.prototype.addIceCandidate, n.RTCPeerConnection.prototype.addIceCandidate = function(e, t) {
                    ...
                    n.RTCPeerConnection.prototype.getStats = function() {
                        var e = Array.prototype.slice.call(arguments),
                            ...
                            n = e[1],
                            r = e[2];
                        return o.apply(this, [t || null]).then(function(r) {
                            if (i.version < 53 && !n)
                                try {
                ...
                r.shimSenderGetStats = function(e) {
                    if ("object" !== (void 0 === e ? "undefined" : c(e)) || !e.RTCPeerConnection || !e.RTCRtpSender)
                        return;
                ...
                r.shimAddTransceiver = function(e) {
                    if ("object" !== (void 0 === e ? "undefined" : c(e)) || !e.RTCPeerConnection)
                        return;
                    ...
                    s && (e.RTCPeerConnection.prototype.addTransceiver = function(e, t) {
                        ...
                        n && r.sendEncodings.forEach(function(e) {
                            ...
                            if ("scaleResolutionDownBy" in e && !(1 <= parseFloat(e.scaleResolutionDownBy)))
                                throw new RangeError("scale_resolution_down_by must be >= 1.0");
                            if ("maxFramerate" in e && !(0 <= parseFloat(e.maxFramerate)))
                                throw new RangeError("max_framerate must be >= 0.0")
                        });
                        var i,
                            a,
                            o = s.apply(this, arguments);
                        return n && ("encodings" in (a = (i = o.sender).getParameters()) || (a.encodings = r.sendEncodings, this.setParametersPromises.push(i.setParameters(a).catch(function() {})))), o
                    })
                },
        ...
        12: [function(e, t, r) {
            ...
            Object.defineProperty(r, "__esModule", {
                ...
                r.shimGetDisplayMedia = function(r, n) {
                    if (r.navigator.mediaDevices && "getDisplayMedia" in r.navigator.mediaDevices)
                        return;
        ...
        13: [function(e, t, r) {
            ...
            r.shimGetUserMedia = function(e) {
                    ...
                    r = e && e.MediaStreamTrack;
                {
                    ...
                    55 < t.version && "autoGainControl" in n.mediaDevices.getSupportedConstraints() || (i = function(e, t, r) {
                        t in e && !(r in e) && (e[r] = e[t], delete e[t])
                    }, a = n.mediaDevices.getUserMedia.bind(n.mediaDevices), n.mediaDevices.getUserMedia = function(e) {
                    ...
                    }, r && r.prototype.getSettings && (o = r.prototype.getSettings, r.prototype.getSettings = function() {
                        var e = o.apply(this, arguments);
                        return i(e, "mozAutoGainControl", "autoGainControl"), i(e, "mozNoiseSuppression", "noiseSuppression"), e
                    }), r && r.prototype.applyConstraints && (s = r.prototype.applyConstraints, r.prototype.applyConstraints = function(e) {
                        return "audio" === this.kind && "object" === (void 0 === e ? "undefined" : c(e)) && (e = JSON.parse(JSON.stringify(e)), i(e, "autoGainControl", "mozAutoGainControl"), i(e, "noiseSuppression", "mozNoiseSuppression")), s.apply(this, [e])
                    }))
                }
            };
            var d = function(e) {
        ...
        14: [function(e, t, r) {
            ...
            r.shimLocalStreamsAPI = function(e) {
                if ("object" !== (void 0 === e ? "undefined" : d(e)) || !e.RTCPeerConnection)
                    return;
                ...
                {
                    var n;
                    "addStream" in e.RTCPeerConnection.prototype || (n = e.RTCPeerConnection.prototype.addTrack, e.RTCPeerConnection.prototype.addStream = function(t) {
                        var r = this;
                        ...
                        var r = t;
                        return r && (this._localStreams ? this._localStreams.includes(r) || this._localStreams.push(r) : this._localStreams = [r]), n.apply(this, arguments)
                    })
                }
                "removeStream" in e.RTCPeerConnection.prototype || (e.RTCPeerConnection.prototype.removeStream = function(e) {
                    ...
                    -1 !== n && (this._localStreams.splice(n, 1), r = e.getTracks(), this.getSenders().forEach(function(e) {
                                ...
                                this._onaddstream && (this.removeEventListener("addstream", this._onaddstream), this.removeEventListener("track", this._onaddstreampoly)),
                                    ...
                                    this.addEventListener("track", this._onaddstreampoly = function(e) {
                                        e.streams.forEach(function(e) {
                                            ...
                                            r._remoteStreams.includes(e) || (r._remoteStreams.push(e), (t = new Event("addstream")).stream = e, r.dispatchEvent(t))
                                        })
                                    })
                            }
                        }), t = e.RTCPeerConnection.prototype.setRemoteDescription, e.RTCPeerConnection.prototype.setRemoteDescription = function() {
                            var r = this;
                            return this._onaddstreampoly || this.addEventListener("track", this._onaddstreampoly = function(e) {
                                e.streams.forEach(function(e) {
                                    var t;
                                    r._remoteStreams || (r._remoteStreams = []),
                                    0 <= r._remoteStreams.indexOf(e) || (r._remoteStreams.push(e), (t = new Event("addstream")).stream = e, r.dispatchEvent(t))
                                })
                            }), t.apply(r, arguments)
                        })
                    }
                ...
                r.shimGetUserMedia = function(e) {
                    var n = e && e.navigator;
                    {
                        var t,
                            r;
                        n.mediaDevices && n.mediaDevices.getUserMedia && (t = n.mediaDevices, r = t.getUserMedia.bind(t), n.mediaDevices.getUserMedia = function(e) {
                            return r(i(e))
                        })
                    }
                ...
                r.shimCreateOfferLegacy = function(e) {
                    ...
                    e.RTCPeerConnection.prototype.createOffer = function(e) {
                        var t,
                            r;
                        return e && (void 0 !== e.offerToReceiveAudio && (e.offerToReceiveAudio = !!e.offerToReceiveAudio), t = this.getTransceivers().find(function(e) {
                            return "audio" === e.receiver.track.kind
                        }), !1 === e.offerToReceiveAudio && t ? "sendrecv" === t.direction ? t.setDirection ? t.setDirection("sendonly") : t.direction = "sendonly" : "recvonly" === t.direction && (t.setDirection ? t.setDirection("inactive") : t.direction = "inactive") : !0 !== e.offerToReceiveAudio || t || this.addTransceiver("audio"), void 0 !== e.offerToReceiveVideo && (e.offerToReceiveVideo = !!e.offerToReceiveVideo), r = this.getTransceivers().find(function(e) {
                            return "video" === e.receiver.track.kind
                        }), !1 === e.offerToReceiveVideo && r ? "sendrecv" === r.direction ? r.setDirection ? r.setDirection("sendonly") : r.direction = "sendonly" : "recvonly" === r.direction && (r.setDirection ? r.setDirection("inactive") : r.direction = "inactive") : !0 !== e.offerToReceiveVideo || r || this.addTransceiver("video")), n.apply(this, arguments)
                    }
                };
            var o = function(e) {
                {
                ...
                r.wrapPeerConnectionEvent = function(e, n, i) {
                    ...
                    t.removeEventListener = function(e, t) {
                        ...
                        Object.defineProperty(t, "on" + n, {
                            ...
                            set: function(e) {
                                this["_on" + n] && (this.removeEventListener(n, this["_on" + n]), delete this["_on" + n]),
        ...
        16: [function(e, t, r) {
            ...
            function A(d, p) {
                ...
                return d.codecs.forEach(function(r) {
                    for (var e, t, n, i, a, o, s = 0; s < p.codecs.length; s++) {
                        var c = p.codecs[s];
                        if (r.name.toLowerCase() === c.name.toLowerCase() && r.clockRate === c.clockRate) {
                            if ("rtx" === r.name.toLowerCase() && r.parameters && c.parameters.apt && (e = r, t = c, n = d.codecs, i = p.codecs, o = a = void 0, a = u(e.parameters.apt, n), o = u(t.parameters.apt, i), !a || !o || a.name.toLowerCase() !== o.name.toLowerCase()))
                                continue;
                            (c = JSON.parse(JSON.stringify(c))).numChannels = Math.min(r.numChannels, c.numChannels),
                                f.codecs.push(c),
                                c.rtcpFeedback = c.rtcpFeedback.filter(function(e) {
            ...
            t.exports = function(I, j) {
                ...
                function n(e) {
                    ...
                    if (["addEventListener", "removeEventListener", "dispatchEvent"].forEach(function(e) {
                        r[e] = a[e].bind(a)
                    }), this.canTrickleIceCandidates = null, this.needNegotiation = !1, this.localStreams = [], this.remoteStreams = [], this._localDescription = null, this._remoteDescription = null, this.signalingState = "stable", this.iceConnectionState = "new", this.connectionState = "new", this.iceGatheringState = "new", e = JSON.parse(JSON.stringify(e || {})), this.usingBundle = "max-bundle" === e.bundlePolicy, "negotiate" === e.rtcpMuxPolicy)
                        throw m("NotSupportedError", "rtcpMuxPolicy 'negotiate' is not supported");
                    ...
                    if (e.iceServers = (t = e.iceServers || [], n = j, i = !1, (t = JSON.parse(JSON.stringify(t))).filter(function(e) {
                        if (e && (e.urls || e.url)) {
                            var t = e.urls || e.url;
                ...
                Object.defineProperty(n.prototype, "localDescription", {
                    ...
                    n.prototype._createTransceiver = function(e, t) {
                        ...
                        return this.usingBundle && n ? (i.iceTransport = this.transceivers[0].iceTransport, i.dtlsTransport = this.transceivers[0].dtlsTransport) : (r = this._createIceAndDtlsTransports(), i.iceTransport = r.iceTransport, i.dtlsTransport = r.dtlsTransport), t || this.transceivers.push(i), i
                    },
                    n.prototype.addTrack = function(t, e) {
                        if (this._isClosed)
                            throw m("InvalidStateError", "Attempted to call addTrack on a closed peerconnection.");
                        var r;
                    ...
                    n.prototype.addStream = function(t) {
                        var n,
                            r = this;
                        15025 <= j ? t.getTracks().forEach(function(e) {
                            r.addTrack(e, t)
                        }) : (n = t.clone(), t.getTracks().forEach(function(e, t) {
                            var r = n.getTracks()[t];
                    ...
                    n.prototype.removeTrack = function(t) {
                        if (this._isClosed)
                            throw m("InvalidStateError", "Attempted to call removeTrack on a closed peerconnection.");
                        ...
                        if (!e)
                            throw m("InvalidAccessError", "Sender was not created by this connection.");
                        var r = e.stream;
                        e.rtpSender.stop(),
                            e.rtpSender = null,
                            e.track = null,
                        ...
                        -1 === this.transceivers.map(function(e) {
                            return e.stream
                        }).indexOf(r) && -1 < this.localStreams.indexOf(r) && this.localStreams.splice(this.localStreams.indexOf(r), 1),
                    ...
                    n.prototype._createIceGatherer = function(r, e) {
                        ...
                        return Object.defineProperty(i, "state", {
                            ...
                            null !== n.transceivers[r].bufferedCandidateEvents && n.transceivers[r].bufferedCandidateEvents.push(e)
                    ...
                    n.prototype._gather = function(s, c) {
                        ...
                        p.onlocalcandidate || (e = this.transceivers[c].bufferedCandidateEvents, this.transceivers[c].bufferedCandidateEvents = null, p.removeEventListener("localcandidate", this.transceivers[c].bufferCandidates), p.onlocalcandidate = function(e) {
                            var t,
                                r,
                                n,
                                i,
                                a,
                                o;
                            d.usingBundle && 0 < c || ((t = new Event("icecandidate")).candidate = {
                                sdpMid: s,
                                sdpMLineIndex: c
                            }, (n = !(r = e.candidate) || 0 === Object.keys(r).length) ? "new" !== p.state && "gathering" !== p.state || (p.state = "completed") : ("new" === p.state && (p.state = "gathering"), r.component = 1, r.ufrag = p.getLocalParameters().usernameFragment, i = G.writeCandidate(r), t.candidate = Object.assign(t.candidate, G.parseCandidate(i)), t.candidate.candidate = i, t.candidate.toJSON = function() {
                                return {
                            ...
                            }), (a = G.getMediaSections(d._localDescription.sdp))[t.candidate.sdpMLineIndex] += n ? "a=end-of-candidates\r\n" : "a=" + t.candidate.candidate + "\r\n", d._localDescription.sdp = G.getDescription(d._localDescription.sdp) + a.join(""), o = d.transceivers.every(function(e) {
                    ...
                    n.prototype._transceive = function(e, t, r) {
                        ...
                        }, e.recvEncodingParameters.length && (n.rtcp.ssrc = e.recvEncodingParameters[0].ssrc), e.rtpSender.send(n)),
                        r && e.rtpReceiver && 0 < n.codecs.length && ("video" === e.kind && e.recvEncodingParameters && j < 15019 && e.recvEncodingParameters.forEach(function(e) {
                            delete e.rtx
                    ...
                    n.prototype.setLocalDescription = function(e) {
                        var t,
                            ...
                            f,
                            l = this;
                        return -1 === ["offer", "answer"].indexOf(e.type) ? Promise.reject(m("TypeError", 'Unsupported type "' + e.type + '"')) : !a("setLocalDescription", e.type, l.signalingState) || l._isClosed ? Promise.reject(m("InvalidStateError", "Can not set local " + e.type + " in state " + l.signalingState)) : ("offer" === e.type ? (t = G.splitSections(e.sdp), u = t.shift(), t.forEach(function(e, t) {
                            var r = G.parseRtpParameters(e);
                            l.transceivers[t].localCapabilities = r
                        }), l.transceivers.forEach(function(e, t) {
                            l._gather(e.mid, t)
                        })) : "answer" === e.type && (t = G.splitSections(l._remoteDescription.sdp), u = t.shift(), f = 0 < G.matchPrefix(u, "a=ice-lite").length, t.forEach(function(e, t) {
                            var r,
                                n,
                                i,
                                a = l.transceivers[t],
                            ...
                            G.isRejected(e) && 0 === G.matchPrefix(e, "a=bundle-only").length || a.rejected || (r = G.getIceParameters(e, u), n = G.getDtlsParameters(e, u), f && (n.role = "server"), l.usingBundle && 0 !== t || (l._gather(a.mid, t), "new" === s.state && s.start(o, r, f ? "controlling" : "controlled"), "new" === c.state && c.start(n)), i = A(d, p), l._transceive(a, 0 < i.codecs.length, !1))
                        })), l._localDescription = {
                            type: e.type,
                            sdp: e.sdp
                        }, "offer" === e.type ? l._updateSignalingState("have-local-offer") : l._updateSignalingState("stable"), Promise.resolve())
                    },
                    n.prototype.setRemoteDescription = function(_) {
                        var w = this;
                        if (-1 === ["offer", "answer"].indexOf(_.type))
                            return Promise.reject(m("TypeError", 'Unsupported type "' + _.type + '"'));
                        if (!a("setRemoteDescription", _.type, w.signalingState) || w._isClosed)
                            return Promise.reject(m("InvalidStateError", "Can not set remote " + _.type + " in state " + w.signalingState));
                        var k = {};
                        ...
                        return w.canTrickleIceCandidates = !!t && 0 <= t.substr(14).split(" ").indexOf("trickle"), e.forEach(function(e, t) {
                            var i,
                                ...
                                C = G.splitLines(e),
                                S = G.getKind(e),
                                T = G.isRejected(e) && 0 === G.matchPrefix(e, "a=bundle-only").length,
                                P = C[0].substr(2).split(" ")[2],
                                R = G.getDirection(e, M),
                                b = G.parseMsid(e),
                                E = G.getMid(e) || G.generateIdentifier();
                            T || "application" === S && ("DTLS/SCTP" === P || "UDP/DTLS/SCTP" === P) ? w.transceivers[t] = {
                                mid: E,
                                kind: S,
                                protocol: P,
                                rejected: !0
                            } : (!T && w.transceivers[t] && w.transceivers[t].rejected && (w.transceivers[t] = w._createTransceiver(S, !0)), o = G.parseRtpParameters(e), T || (s = G.getIceParameters(e, M), (c = G.getDtlsParameters(e, M)).role = "client"), n = G.parseRtpEncodingParameters(e), d = G.parseRtcpParameters(e), p = 0 < G.matchPrefix(e, "a=end-of-candidates", M).length, u = G.matchPrefix(e, "a=candidate:").map(function(e) {
                                return G.parseCandidate(e)
                            }).filter(function(e) {
                                return 1 === e.component
                            }), ("offer" === _.type || "answer" === _.type) && !T && O && 0 < t && w.transceivers[t] && (w._disposeIceAndDtlsTransports(t), w.transceivers[t].iceGatherer = w.transceivers[0].iceGatherer, w.transceivers[t].iceTransport = w.transceivers[0].iceTransport, w.transceivers[t].dtlsTransport = w.transceivers[0].dtlsTransport, w.transceivers[t].rtpSender && w.transceivers[t].rtpSender.setTransport(w.transceivers[0].dtlsTransport), w.transceivers[t].rtpReceiver && w.transceivers[t].rtpReceiver.setTransport(w.transceivers[0].dtlsTransport)), "offer" !== _.type || T ? "answer" !== _.type || T || (f = (i = w.transceivers[t]).iceGatherer, l = i.iceTransport, m = i.dtlsTransport, g = i.rtpReceiver, r = i.sendEncodingParameters, a = i.localCapabilities, w.transceivers[t].recvEncodingParameters = n, w.transceivers[t].remoteCapabilities = o, w.transceivers[t].rtcpParameters = d, u.length && "new" === l.state && (!D && !p || O && 0 !== t ? u.forEach(function(e) {
                                N(i.iceTransport, e)
                            }) : l.setRemoteCandidates(u)), O && 0 !== t || ("new" === l.state && l.start(f, s, "controlling"), "new" === m.state && m.start(c)), !A(i.localCapabilities, i.remoteCapabilities).codecs.filter(function(e) {
                                return "rtx" === e.name.toLowerCase()
                            }).length && i.sendEncodingParameters[0].rtx && delete i.sendEncodingParameters[0].rtx, w._transceive(i, "sendrecv" === R || "recvonly" === R, "sendrecv" === R || "sendonly" === R), !g || "sendrecv" !== R && "sendonly" !== R ? delete i.rtpReceiver : (v = g.track, b ? (k[b.stream] || (k[b.stream] = new I.MediaStream), L(v, k[b.stream]), x.push([v, g, k[b.stream]])) : (k.default || (k.default = new I.MediaStream), L(v, k.default), x.push([v, g, k.default])))) : ((i = w.transceivers[t] || w._createTransceiver(S)).mid = E, i.iceGatherer || (i.iceGatherer = w._createIceGatherer(t, O)), u.length && "new" === i.iceTransport.state && (!p || O && 0 !== t ? u.forEach(function(e) {
                                N(i.iceTransport, e)
                            }) : i.iceTransport.setRemoteCandidates(u)), a = I.RTCRtpReceiver.getCapabilities(S), j < 15019 && (a.codecs = a.codecs.filter(function(e) {
                                return "rtx" !== e.name
                            })), r = i.sendEncodingParameters || [{
                                ssrc: 1001 * (2 * t + 2)
                            }], y = !1, "sendrecv" === R || "sendonly" === R ? (y = !i.rtpReceiver, g = i.rtpReceiver || new I.RTCRtpReceiver(i.dtlsTransport, S), y && (v = g.track, b && "-" === b.stream || (h = b ? (k[b.stream] || (k[b.stream] = new I.MediaStream, Object.defineProperty(k[b.stream], "id", {
                                get: function() {
                                    return b.stream
                                }
                            ...
                            }), k[b.stream]) : (k.default || (k.default = new I.MediaStream), k.default)), h && (L(v, h), i.associatedRemoteMediaStreams.push(h)), x.push([v, g, h]))) : i.rtpReceiver && i.rtpReceiver.track && (i.associatedRemoteMediaStreams.forEach(function(e) {
                                var t,
                                    r,
                            ...
                            }), i.associatedRemoteMediaStreams = []), i.localCapabilities = a, i.remoteCapabilities = o, i.rtpReceiver = g, i.rtcpParameters = d, i.sendEncodingParameters = r, i.recvEncodingParameters = n, w._transceive(w.transceivers[t], !1, y)))
                            ...
                            var t,
                                n = k[e];
                            n.getTracks().length && (-1 === w.remoteStreams.indexOf(n) && (w.remoteStreams.push(n), (t = new Event("addstream")).stream = n, I.setTimeout(function() {
                    ...
                    n.prototype._maybeFireNegotiationNeeded = function() {
                        ...
                        "stable" === this.signalingState && !0 !== this.needNegotiation && (this.needNegotiation = !0, I.setTimeout(function() {
                            var e;
                            t.needNegotiation && (t.needNegotiation = !1, e = new Event("negotiationneeded"), t._dispatchEvent("negotiationneeded", e))
                        }, 0))
                    },
                    n.prototype._updateIceConnectionState = function() {
                        ...
                        this.transceivers.forEach(function(e) {
                            e.iceTransport && !e.rejected && r[e.iceTransport.state]++
                        }),
                            e = "new",
                            0 < r.failed ? e = "failed" : 0 < r.checking ? e = "checking" : 0 < r.disconnected ? e = "disconnected" : 0 < r.new ? e = "new" : 0 < r.connected ? e = "connected" : 0 < r.completed && (e = "completed"),
                        e !== this.iceConnectionState && (this.iceConnectionState = e, t = new Event("iceconnectionstatechange"), this._dispatchEvent("iceconnectionstatechange", t))
                    },
                    n.prototype._updateConnectionState = function() {
                        ...
                        this.transceivers.forEach(function(e) {
                            e.iceTransport && e.dtlsTransport && !e.rejected && (r[e.iceTransport.state]++, r[e.dtlsTransport.state]++)
                        }),
                            r.connected += r.completed,
                            e = "new",
                            0 < r.failed ? e = "failed" : 0 < r.connecting ? e = "connecting" : 0 < r.disconnected ? e = "disconnected" : 0 < r.new ? e = "new" : 0 < r.connected && (e = "connected"),
                        e !== this.connectionState && (this.connectionState = e, t = new Event("connectionstatechange"), this._dispatchEvent("connectionstatechange", t))
                    },
                    n.prototype.createOffer = function() {
                        var s = this;
                        if (s._isClosed)
                            return Promise.reject(m("InvalidStateError", "Can not call createOffer after close"));
                        ...
                        if (e) {
                            ...
                            void 0 !== e.offerToReceiveVideo && (r = !0 === e.offerToReceiveVideo ? 1 : !1 === e.offerToReceiveVideo ? 0 : e.offerToReceiveVideo)
                        }
                        ...
                        s.transceivers.forEach(function(e, t) {
                            ...
                            e.mid = i,
                            e.iceGatherer || (e.iceGatherer = s._createIceGatherer(t, s.usingBundle));
                        ...
                        "max-compat" !== s._config.bundlePolicy && (n += "a=group:BUNDLE " + s.transceivers.map(function(e) {
                            ...
                            s.transceivers.forEach(function(e, t) {
                                n += c(e, e.localCapabilities, "offer", e.stream, s._dtlsRole),
                                    n += "a=rtcp-rsize\r\n",
                    ...
                    n.prototype.createAnswer = function() {
                        var i = this;
                        if (i._isClosed)
                            return Promise.reject(m("InvalidStateError", "Can not call createAnswer after close"));
                        if ("have-remote-offer" !== i.signalingState && "have-local-pranswer" !== i.signalingState)
                            return Promise.reject(m("InvalidStateError", "Can not call createAnswer in signalingState " + i.signalingState));
                        ...
                        i.transceivers.forEach(function(e, t) {
                            if (!(o < t + 1)) {
                                ...
                                var r;
                                e.stream && ("audio" === e.kind ? r = e.stream.getAudioTracks()[0] : "video" === e.kind && (r = e.stream.getVideoTracks()[0]), r && 15019 <= j && "video" === e.kind && !e.sendEncodingParameters[0].rtx && (e.sendEncodingParameters[0].rtx = {
                    ...
                    n.prototype.addIceCandidate = function(c) {
                        ...
                        return c && void 0 === c.sdpMLineIndex && !c.sdpMid ? Promise.reject(new TypeError("sdpMLineIndex or sdpMid required")) : new Promise(function(e, t) {
                            if (!p._remoteDescription)
                                return t(m("InvalidStateError", "Can not add ICE candidate without a remote description"));
                            if (c && "" !== c.candidate) {
                                ...
                                if (!i)
                                    return t(m("OperationError", "Can not add ICE candidate"));
                                if (i.rejected)
                                    return e();
                                ...
                                if (a.component && 1 !== a.component)
                                    return e();
                                if ((0 === r || 0 < r && i.iceTransport !== p.transceivers[0].iceTransport) && !N(i.iceTransport, a))
                                    return t(m("OperationError", "Can not add ICE candidate"));
                                var o = c.candidate.trim();
                                0 === o.indexOf("a=") && (o = o.substr(2)),
                                    (d = G.getMediaSections(p._remoteDescription.sdp))[r] += "a=" + (a.type ? o : "end-of-candidates") + "\r\n",
                                    p._remoteDescription.sdp = G.getDescription(p._remoteDescription.sdp) + d.join("")
                            } else
                                for (var s = 0; s < p.transceivers.length && (p.transceivers[s].rejected || (p.transceivers[s].iceTransport.addRemoteCandidate({}), (d = G.getMediaSections(p._remoteDescription.sdp))[s] += "a=end-of-candidates\r\n", p._remoteDescription.sdp = G.getDescription(p._remoteDescription.sdp) + d.join(""), !p.usingBundle)); s++)
                                    ;
                            e()
                        })
                    },
                ...
                ["RTCRtpSender", "RTCRtpReceiver", "RTCIceGatherer", "RTCIceTransport", "RTCDtlsTransport"].forEach(function(e) {
                    var t,
                        r = I[e];
                    r && r.prototype && r.prototype.getStats && (t = r.prototype.getStats, r.prototype.getStats = function() {
        ...
        17: [function(e, t, r) {
            ...
            p.localCName = p.generateIdentifier(),
                ...
                p.parseCandidate = function(e) {
                    for (var t = 0 === e.indexOf("a=candidate:") ? e.substring(12).split(" ") : e.substring(10).split(" "), r = {
                        foundation: t[0],
                ...
                p.parseRtpMap = function(e) {
                    var t = e.substr(9).split(" "),
                        ...
                        t = t[0].split("/");
                    return r.name = t[0], r.clockRate = parseInt(t[1], 10), r.channels = 3 === t.length ? parseInt(t[2], 10) : 1, r.numChannels = r.channels, r
                },
                ...
                p.writeFmtp = function(t) {
                    var r,
                        e = "",
                        n = t.payloadType;
                    return void 0 !== t.preferredPayloadType && (n = t.preferredPayloadType), t.parameters && Object.keys(t.parameters).length && (r = [], Object.keys(t.parameters).forEach(function(e) {
                ...
                p.writeCryptoLine = function(e) {
                    return "a=crypto:" + e.tag + " " + e.cryptoSuite + " " + ("object" == typeof e.keyParams ? p.writeCryptoKeyParams(e.keyParams) : e.keyParams) + (e.sessionParams ? " " + e.sessionParams.join(" ") : "") + "\r\n"
                },
                ...
                p.parseRtpEncodingParameters = function(e) {
                    ...
                    0 < c.length && 1 < c[0].length && c[0][0] === s && (r = c[0][1]),
                        t.codecs.forEach(function(e) {
                            var t;
                            "RTX" === e.name.toUpperCase() && e.parameters.apt && (t = {
                                ssrc: s,
                ...
                p.writeSctpDescription = function(e, t) {
                    var r = [],
                        r = "DTLS/SCTP" !== e.protocol ? ["m=" + e.kind + " 9 " + e.protocol + " " + t.protocol + "\r\n", "c=IN IP4 0.0.0.0\r\n", "a=sctp-port:" + t.port + "\r\n"] : ["m=" + e.kind + " 9 " + e.protocol + " " + t.port + "\r\n", "c=IN IP4 0.0.0.0\r\n", "a=sctpmap:" + t.port + " " + t.protocol + " 65535\r\n"];
                ...
                p.writeSessionBoilerplate = function(e, t, r) {
                    var n = void 0 !== t ? t : 2,
                        i = e || p.generateSessionId();
                    return "v=0\r\no=" + (r || "thisisadapterortc") + " " + i + " " + n + " IN IP4 127.0.0.1\r\ns=-\r\nt=0 0\r\n"
                },
                p.writeMediaSection = function(e, t, r, n) {
                    var i,
                        a = p.writeRtpDescription(e.kind, t);
                    return a += p.writeIceParameters(e.iceGatherer.getLocalParameters()), a += p.writeDtlsParameters(e.dtlsTransport.getLocalParameters(), "offer" === r ? "actpass" : "active"), a += "a=mid:" + e.mid + "\r\n", e.direction ? a += "a=" + e.direction + "\r\n" : e.rtpSender && e.rtpReceiver ? a += "a=sendrecv\r\n" : e.rtpSender ? a += "a=sendonly\r\n" : e.rtpReceiver ? a += "a=recvonly\r\n" : a += "a=inactive\r\n", e.rtpSender && (a += "a=" + (i = "msid:" + n.id + " " + e.rtpSender.track.id + "\r\n"), a += "a=ssrc:" + e.sendEncodingParameters[0].ssrc + " " + i, e.sendEncodingParameters[0].rtx && (a += "a=ssrc:" + e.sendEncodingParameters[0].rtx.ssrc + " " + i, a += "a=ssrc-group:FID " + e.sendEncodingParameters[0].ssrc + " " + e.sendEncodingParameters[0].rtx.ssrc + "\r\n")), a += "a=ssrc:" + e.sendEncodingParameters[0].ssrc + " cname:" + p.localCName + "\r\n", e.rtpSender && e.sendEncodingParameters[0].rtx && (a += "a=ssrc:" + e.sendEncodingParameters[0].rtx.ssrc + " cname:" + p.localCName + "\r\n"), a
                },
