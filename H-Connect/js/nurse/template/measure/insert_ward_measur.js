...
function Create_ward_list_measure_Bed(wardList){
    ...
    $(".section.new_hospital .hospital_patient .selectBox2.s_select .optionList.ward_option2 .ward_list2").on("click", function(){
        ...
        $(".section.new_hospital .hospital_patient .selectBox2.s_select .optionList.room_option2").html(new_sickRoomList); //병실에 병동의 맞는 새로운 리스트 정렬
...
function roomSelectHandle2(){
    ...
    const $title = $(this).text();
    $(".section.measure_status .search_select .selectBox2.s_select .room_label2").text($title);
    $(".section.measure_status .search_select .selectBox2.s_select .room_label2").attr("data-sickroomcode", $(this).data("sickroomcode"));
    $(this).parent().parent().removeClass("active");
    ...
    $(".section.measure_status .search_select .selectBox2.select_bed .optionList.bed_option").html(new_sickBed_html);
